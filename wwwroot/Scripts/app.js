...
$(document).ready(function ($) {
    //$('#BusinessName').load(function () {
    //    $.ajax({
    //        type: "POST",
    //        url: "/EditProfile/GetBusiness",
	...
	$('#BusinessName').change(function () {
		...
		$.ajax({
			type: "POST",
			url: "/EditProfile/SetBusiness",
			data: {
                businessId: $(this).children("option:selected").val()
			},
			success: function() {
    ...
    $('#editProductModal').on('shown.bs.modal', function () {
      $('#quantityReceived').trigger('focus')
    });

	$('#batchBarcode').keypress(function (event) {
